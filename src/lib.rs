// src/lib.rs
/*
 * Core library for HelperFunctions
 */
...
#[derive(Debug)]
pub struct HelperFunctionsProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HelperFunctionsProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HelperFunctions processing");
    
    let mut processor = HelperFunctionsProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HelperFunctionsProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HelperFunctionsProcessor::new(false);
